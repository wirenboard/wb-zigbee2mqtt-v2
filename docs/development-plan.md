...
- **Очистка MQTT** — ghost cleanup при старте удаляет retained-мусор от v1 (а также от ранних сборок v2 до переименования драйвера) по маркерам `driver: wb-mqtt-zigbee` и legacy `wb-zigbee2mqtt`.
