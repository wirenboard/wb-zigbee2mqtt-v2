...
from wb.mqtt_zigbee.registered_device import PendingCommand
from wb.mqtt_zigbee.bridge import _is_safe_topic_name
...
class TestTopicSafety:
    ...
    def test_is_safe_topic_name(self, name, expected):
        assert _is_safe_topic_name(name) == expected
